        ...
        <div>
            ...
            >
                <div class=card_style::card_thumbnail>
                    ...
                    <img class=card_style::card_done style:visibility=move || {if workout.done.get() { "visible" } else { "hidden" }} src="https://upload.wikimedia.org/wikipedia/commons/3/3b/Eo_circle_green_checkmark.svg"/>
                </div>
